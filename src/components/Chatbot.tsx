  ...
  return (
    <div className="fixed z-50 bottom-24 left-1/2 -translate-x-1/2 md:bottom-6 md:left-auto md:right-6 md:translate-x-0">
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="glass-card rounded-[32px] w-[90vw] sm:w-[380px] h-[60vh] sm:h-[550px] flex flex-col overflow-hidden mb-4 shadow-2xl border-white/40"
          >
      ...
      <motion.button
        ...
        className="liquid-btn text-white p-4 rounded-[24px] shadow-2xl shadow-shopee-blue/30 relative group overflow-hidden hidden md:flex"
      >
